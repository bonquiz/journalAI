...
The derived key is cached: PBKDF2 costs ~2.4s per derivation and is only
needed once per process lifetime (settings.secret_key_wrap is static).
"""
import base64
